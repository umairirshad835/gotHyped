                ...
                <div class="row">
                    <div class="col-xl-6 col-md-6">
                        <div class="form-group">
                            ...
                            <input id="name" class="form-control @error('name') is-invalid @enderror limitinput" value="{{ old('name') }}" name="name" type="text" placeholder="Enter package name">
                                @error('name')
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-6">
                        <div class="form-group">
                            ...
                            <input id="price" class="form-control @error('price') is-invalid @enderror" value="{{ old('price') }}" name="price" type="number" placeholder="Enter bid price" min="1" step="any">
                                @error('price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
