                ...
                <div class="row">
                    <div class="col-xl-12 col-md-12">
                        <div class="form-group">
                            ...
                            <textarea id="descripton" class="form-control @error('descripton') is-invalid @enderror" value="{{ old('descripton') }}" name="descripton" type="text" placeholder="Enter description"></textarea>
                                @error('descripton')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
