                        ...
                        <ul class="task-list">
                            <li class="d-sm-flex">
                                <div>
                                    ...
                                    <h6 class="fw-semibold">Task Finished<span
                                            class="text-muted fs-11 ms-2 fw-normal">09 July 2021</span>
                                    </h6>
                            ...
                            <li class="d-sm-flex">
                                <div>
                                    ...
                                    <h6 class="fw-semibold">New Comment<span
                                            class="text-muted fs-11 ms-2 fw-normal">05 July 2021</span>
                                    </h6>
                            ...
                            <li class="d-sm-flex">
                                <div>
                                    ...
                                    <h6 class="fw-semibold">New Comment<span
                                            class="text-muted fs-11 ms-2 fw-normal">25 June 2021</span>
                                    </h6>
                                    <p class="text-muted fs-12">Victoria commented on Project <a
                                            href="javascript:void(0)" class="fw-semibold"> AngularJS Template</a></p>
                                </div>
                            ...
                            <li class="d-sm-flex">
                                <div>
                                    ...
                                    <h6 class="fw-semibold">Task Overdue<span
                                            class="text-muted fs-11 ms-2 fw-normal">14 June 2021</span>
                                    </h6>
                            ...
                            <li class="d-sm-flex">
                                <div>
                                    ...
                                    <h6 class="fw-semibold">Task Overdue<span
                                            class="text-muted fs-11 ms-2 fw-normal">29 June 2021</span>
                                    </h6>
                                    <p class="text-muted mb-0 fs-12">Petey Cruiser finished task <a
                                            href="javascript:void(0)" class="fw-semibold"> Integrated management</a></p>
                                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="browser-stats">
                            ...
                            <div class="row mb-4">
                                <div class="col-sm-2 col-lg-3 col-xl-3 col-xxl-2 mb-sm-0 mb-3">
                                    <img src="{{ asset('assets/images/browsers/edge') }}" class="img-fluid"
                                        alt="img">
                                </div>
                                <div class="col-sm-10 col-lg-9 col-xl-9 col-xxl-10 ps-sm-0">
                                    <div class="d-flex align-items-end justify-content-between mb-1">
                                                        ...
                                                        <tbody>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex">
                                                                        <span class="avatar bradius"
                                                                            style="background-image: {{ asset('assets/images/orders/10.jpg') }})"></span>
                                                                        <div
                                                            ...
                                                            <tr class="border-bottom">
                                                                ...
                                                                <td>
                                                                    <div class="d-flex">
                                                                        <span class="avatar bradius"
                                                                            style="background-image: {{ asset('assets/images/orders/12.jpg') }}"></span>
                                                                        <div
                                                                            class="ms-3 mt-0 mt-sm-2 d-block">
                                                                            <h6
                                                                                class="mb-0 fs-14 fw-semibold">
                                                            ...
                                                            <tr class="border-bottom">
                                                                ...
                                                                <td>
                                                                    <div class="d-flex">
                                                                        <span class="avatar bradius"
                                                                            style="background-image: {{ asset('assets/images/orders/4.jpg') }}"></span>
                                                                        <div
                                                                            class="ms-3 mt-0 mt-sm-2 d-block">
                                                                            <h6
                                                                                class="mb-0 fs-14 fw-semibold">
                                                            ...
                                                            <tr class="border-bottom">
                                                                ...
                                                                <td>
                                                                    <div class="d-flex">
                                                                        <span class="avatar bradius"
                                                                            style="background-image: {{ asset('assets/images/orders/8.jpg') }}"></span>
                                                                        <div
                                                                            class="ms-3 mt-0 mt-sm-2 d-block">
                                                                            <h6
                                                                                class="mb-0 fs-14 fw-semibold">
                                                            ...
                                                            <tr class="border-bottom">
                                                                ...
                                                                <td>
                                                                    <div class="d-flex">
                                                                        <span class="avatar bradius"
                                                                            style="background-image: {{ asset('assets/images/orders/6.jpg') }}"></span>
                                                                        <div
                                                                            class="ms-3 mt-0 mt-sm-2 d-block">
                                                                            <h6
                                                                                class="mb-0 fs-14 fw-semibold">
                                                            ...
                                                            <tr class="border-bottom">
                                                                ...
                                                                <td>
                                                                    <div class="d-flex">
                                                                        <span class="avatar bradius"
                                                                            style="background-image: {{ asset('assets/images/orders/1.jpg') }}"></span>
                                                                        <div
                                                                            class="ms-3 mt-0 mt-sm-2 d-block">
                                                                            <h6
                                                                                class="mb-0 fs-14 fw-semibold">
                                                            ...
                                                            <tr class="border-bottom">
                                                                ...
                                                                <td>
                                                                    <div class="d-flex">
                                                                        <span class="avatar bradius"
                                                                            style="background-image: {{ asset('assets/images/orders/11.jpg') }}"></span>
                                                                        <div
                                                                            class="ms-3 mt-0 mt-sm-2 d-block">
                                                                            <h6
                                                                                class="mb-0 fs-14 fw-semibold">
                                                            ...
                                                            <tr class="border-bottom">
                                                                ...
                                                                <td>
                                                                    <div class="d-flex">
                                                                        <span class="avatar bradius"
                                                                            style="background-image: {{ asset('assets/images/orders/2.jpg') }}"></span>
                                                                        <div
                                                                            class="ms-3 mt-0 mt-sm-2 d-block">
                                                                            <h6
                                                                                class="mb-0 fs-14 fw-semibold">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="border-bottom">
                                                                ...
                                                                <td>
                                                                    <div class="d-flex">
                                                                        <span class="avatar bradius"
                                                                            style="background-image: {{ asset('assets/images/orders/2') }}"></span>
                                                                        <div
                                                                            class="ms-3 mt-0 mt-sm-2 d-block">
                                                                            <h6
                                                                                class="mb-0 fs-14 fw-semibold">
